...
func (*KernelDef) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{0} }
...
func (*KernelDef_AttrConstraint) Descriptor() ([]byte, []int) { return fileDescriptor8, []int{0, 0} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/kernel_def.proto", fileDescriptor8) }
