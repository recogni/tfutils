...
func (*SavedModel) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func init() { proto.RegisterFile("tensorflow/core/protobuf/saved_model.proto", fileDescriptor1) }
